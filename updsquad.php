...
<?
  ...
  if ($upd==1)
	{
	 mysql_query("UPDATE squad SET  idspec=$idspec,  idfaculty=$idfaculty , squad='$squad' where idsquad=$id");		
	}
else
  {//формирование SQL-запроса на добавление данных
	mysql_query("insert into squad ( idspec,  idfaculty,  squad) values ($idspec, $idfaculty,  '$squad')");
          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
               ...
               <li class="current"><a href="squad.php">Группы</a></li>
<?
if ($mode!="")
{
?> 
...
{
$Arr=$_REQUEST["Arr"];
$r=mysql_query("SELECT * FROM squad where idsquad="."$Arr[0]");
...
{
?>
        <h3>Редактирование группы (режим преподавателя)</h3>   
<?
}
else
{
?>
        <h3>Добавление группы (режим преподавателя)</h3>   
<?
}
?>          
      </div>
...
<form name="form2" method="post"  enctype="multipart/form-data" >
				  <table  border="0" align="">
                    ...
                    <tr>
                      ...
                      <td><input   name="squad"   type="text"  value="<? if ($upd==1) echo "$f[squad]"; else echo(""); ?>" size="40" ></td>
                    </tr>
                    <tr>
...
?>
				...
				<br>
				<input  type="button"  name="button"   onclick="this.form.action='updsquad.php?step=2&upd=<? echo"$upd";?>&id=<? echo"$Arr[0]";?>'; this.form.submit();"   value="OK" width="500">
