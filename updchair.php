...
<?
  ...
  if ($upd==1)
	{
	 mysql_query("UPDATE chair SET  chair='$chair' where idchair=$id");		
	}
else
  {//формирование SQL-запроса на добавление данных
	mysql_query("insert into chair (   chair) values (  '$chair')");
...
{
?>
        <h3>Редактирование кафедры (режим преподавателя)</h3>   
<?
}
else
{
?>
        <h3>Добавление кафедры (режим преподавателя)</h3>   
<?
}
?>          
      </div>
